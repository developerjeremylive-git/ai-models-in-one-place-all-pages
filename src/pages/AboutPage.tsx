...
const values = [
	{
		...
		title: 'User-Centric',
		description:
			'We put our users first in everything we do, ensuring our AI models are accessible and valuable.',
	},
	{
		icon: <FiTarget className="w-8 h-8" />,
		title: 'Innovation',
		description:
			'Constantly pushing the boundaries of what\'s possible with artificial intelligence.',
	},
	{
		icon: <FiHeart className="w-8 h-8" />,
		title: 'Ethics',
		description:
			'Committed to developing AI responsibly with transparency and fairness.',
	},
	{
		icon: <FiGlobe className="w-8 h-8" />,
		title: 'Impact',
		description:
			'Focused on creating meaningful change through AI technology across industries.',
	},
]
				...
				<div className="container mx-auto px-4">
					...
					>
						...
						<p className="text-xl text-violet-200 leading-relaxed">
							To empower developers and businesses with cutting-edge AI technology,
							making advanced artificial intelligence accessible and practical for
							everyone.
						</p>
					</motion.div>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
							{values.map((value, index) => (
								...
								>
									...
									<p className="text-violet-200">{value.description}</p>
								</motion.div>
							))}
						</div>
					</motion.div>
